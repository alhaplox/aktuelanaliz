                    ...
                    <div className="col-lg-6">
                        <div className="tp-mission-warp pr-75">
                            <div className="tp-mission-heading">
                                <h3 className="tp-mission-title">The Aktüel Analiz <br /> Mission</h3>
                            </div>
